...
edit_cache:
	...
	"D:\Dev\IDE\CLion 2022.3.3\bin\cmake\win\x64\bin\cmake.exe" -E echo "No interactive CMake dialog available."
.PHONY : edit_cache
...
rebuild_cache:
	...
	"D:\Dev\IDE\CLion 2022.3.3\bin\cmake\win\x64\bin\cmake.exe" --regenerate-during-build -S$(CMAKE_SOURCE_DIR) -B$(CMAKE_BINARY_DIR)
.PHONY : rebuild_cache
...
all: cmake_check_build_system
	$(CMAKE_COMMAND) -E cmake_progress_start D:\Dev\Workspace\C\Other\mystic_melody\CMakeFiles D:\Dev\Workspace\C\Other\mystic_melody\\CMakeFiles\progress.marks
	$(MAKE) $(MAKESILENT) -f CMakeFiles\Makefile2 all
	$(CMAKE_COMMAND) -E cmake_progress_start D:\Dev\Workspace\C\Other\mystic_melody\CMakeFiles 0
.PHONY : all
